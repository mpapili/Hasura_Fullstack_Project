...
var DjangoMigrationWhere = struct {
	...
	ID:      whereHelperint64{field: "\"django_migrations\".\"id\""},
...
func FindDjangoMigration(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*DjangoMigration, error) {
...
func DjangoMigrationExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
