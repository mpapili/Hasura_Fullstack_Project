...
var AuthUserGroupWhere = struct {
	...
	ID:      whereHelperint64{field: "\"auth_user_groups\".\"id\""},
...
func FindAuthUserGroup(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*AuthUserGroup, error) {
...
func AuthUserGroupExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
