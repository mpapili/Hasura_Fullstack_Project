...
var AuthUserUserPermissionWhere = struct {
	...
	ID:           whereHelperint64{field: "\"auth_user_user_permissions\".\"id\""},
...
func FindAuthUserUserPermission(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*AuthUserUserPermission, error) {
	...
	if err = authUserUserPermissionObj.doAfterSelectHooks(ctx, exec); err != nil {
		return authUserUserPermissionObj, err
	}
...
func AuthUserUserPermissionExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
