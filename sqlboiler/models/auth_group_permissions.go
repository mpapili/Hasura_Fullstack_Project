...
var AuthGroupPermissionWhere = struct {
	...
	ID:           whereHelperint64{field: "\"auth_group_permissions\".\"id\""},
...
func FindAuthGroupPermission(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*AuthGroupPermission, error) {
...
func AuthGroupPermissionExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
